# components > Number Input
  ...
  Source: https://raw.githubusercontent.com/chakra-ui/chakra-ui/refs/heads/main/apps/www/content/docs/components/number-input.mdx
  ...
  ***
  ...
  title: Number Input
  description: Used to enter a number, and increment or decrement the value using stepper buttons.
  links: 
 - source: https://github.com/chakra-ui/chakra-ui/tree/main/packages/react/src/components/number-input
 - storybook: https://storybook.chakra-ui.com/?path=/story/components-numberinput--basic
 - recipe: https://github.com/chakra-ui/chakra-ui/tree/main/packages/react/src/theme/recipes/number-input.ts
...
| onValueCommit | undefined | `(details: ValueChangeDetails) => void` | Function invoked when the value is committed (when the input is blurred or the Enter key is pressed) |
