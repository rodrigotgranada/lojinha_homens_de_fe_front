# components > Steps
  ...
  Source: https://raw.githubusercontent.com/chakra-ui/chakra-ui/refs/heads/main/apps/www/content/docs/components/steps.mdx
  ...
  ***
  ...
  links: 
 - source: https://github.com/chakra-ui/chakra-ui/tree/main/packages/react/src/components/steps
 - storybook: https://storybook.chakra-ui.com/?path=/story/components-steps--basic
 - recipe: https://github.com/chakra-ui/chakra-ui/tree/main/packages/react/src/theme/recipes/steps.ts
...
| --- | --- | --- | --- |
| isStepSkippable | () => false | `(index: number) => boolean` | Whether a step can be skipped during navigation.
...
| onStepInvalid | undefined | `(details: StepInvalidDetails) => void` | Called when navigation is blocked due to an invalid step. |
